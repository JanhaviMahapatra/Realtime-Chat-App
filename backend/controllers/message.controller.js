...
// GIPHY GIF
if (
requestedMessageType === "gif" &&
typeof gifUrl === "string" &&
gifUrl.trim()
) {
const isValidGifUrl =
/^https:\/\/([a-z0-9-]+\.)?giphy\.com\//i.test(
	gifUrl.trim()
);
...
// Validate text, file, or GIF message
if (
!message.trim() &&
!req.file &&
messageType !== "gif"
